...
public class SqlProductRepository implements ProductRepository {
    ...
    public ProductOperation findById(ProductId productId) {
        String SQL = "SELECT ID, NAME, DESCRIPTION, BASE_PRICE, TAX_RATE, PRODUCT_STATUS, INVENTORY_QUANTITY FROM PRODUCTS WHERE ID = ?";
    ...
    public List<Product> findAll() {
        String SQL = "SELECT ID, NAME, DESCRIPTION, BASE_PRICE, TAX_RATE, PRODUCT_STATUS, INVENTORY_QUANTITY FROM PRODUCTS";
